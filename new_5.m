...
video_file=VideoWriter('new2.avi');
open(video_file);


%% 소스 영상 객체 생성

vidObj_5=VideoReader('2_ball.mp4');

t=1;
%% 프레임 합치기

video_file_frame= ceil(vidObj_5.Duration * vidObj_5.FrameRate)-1;

for p=1:video_file_frame
   
    imwrite(readFrame(vidObj_5),'frame.jpg')
